(function attachBackgroundPhoneVerification(root, factory) {
  ...
  function createPhoneVerificationHelpers(deps = {}) {
    const {
      ...
      DEFAULT_FIVE_SIM_COUNTRY_ORDER = ['colombia', 'chile', 'brazil', 'england', 'southafrica', 'philippines', 'indonesia', 'usa', 'sweden', 'portugal'],
      DEFAULT_NEX_SMS_BASE_URL = 'https://api.nexsms.net',
      DEFAULT_NEX_SMS_COUNTRY_ORDER = [1],
      DEFAULT_NEX_SMS_SERVICE_CODE = 'ot',
      DEFAULT_SMSBOWER_BASE_URL = 'https://smsbower.app/stubs/handler_api.php',
    ...
    function isExistingPlusOAuthJsonState(state = {}) {
    ...
    async function handoffFreeReusablePhone(tabId, state = {}) {
      ...
      if (isExistingPlusOAuthJsonState(state)) {
        return null;
      }
