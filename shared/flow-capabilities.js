(function attachMultiPageFlowCapabilities(root, factory) {
  ...
  const DEFAULT_PANEL_MODE = 'existing-plus-oauth-json';
  ...
  const VALID_PANEL_MODES = Object.freeze([EXISTING_PLUS_OAUTH_JSON_PANEL_MODE]);
  ...
  const FLOW_CAPABILITIES = Object.freeze({
    openai: Object.freeze({
      ...
      supportsPlatformBinding: ['local-cpa-json', LOCAL_CPA_JSON_NO_RT_PANEL_MODE, EXISTING_PLUS_OAUTH_JSON_PANEL_MODE, 'cpa', 'sub2api', 'codex2api'],
  ...
  const PANEL_CAPABILITIES = Object.freeze({
    ...
    [EXISTING_PLUS_OAUTH_JSON_PANEL_MODE]: Object.freeze({
      supportsPhoneSignup: false,
      supportedPlusAccountAccessStrategies: Object.freeze([PLUS_ACCOUNT_ACCESS_STRATEGY_OAUTH]),
    }),
